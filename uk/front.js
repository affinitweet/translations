export default {
  ...
  _cp: {
    ...
    /* Footer component */
    footer: {
      madeWithLove: '"Афінітвіт" (Affinitweet) це розважально-статистична платформа, що базується на твітері і яка була  створена 2015 року ❤️ у Франції.',
  ...
  _pg: {
    ...
    welcome: {
      ...
      helloYou: 'Здрастуйте, користувачу на ім’я {username}&nbsp;&nbsp;😊',
      proudToWelcomeYou: 'Вітаю, користувачу на ім’я {username}, we are delighted to make your acquaintance and happy to welcome you among our more than 6 million users!',
