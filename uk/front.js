export default {
  ...
  _pg: {
    ...
    index: {
      ...
      fastRealTimeResultsDescription: "Ми побудували Affinitweet за допомогою останніх вебтехнологій, тому це максимально швидко завдяки реальному часу на сторінках можливостей сайту.",
      ...
      totalFeaturesDoneDescription: 'Можливостей зроблено з нашого відкриття в 2014',
    ...
    profile: {
      ...
      joinBeta: 'Долучіться до програми бета-тестування, що протестувати нові можливості до оприлюднення!',
      betaTerms: 'Бета-тестування безкоштовне. Деякі можливості можуть не працювати і можуть бути модифікованими до оприлюднення.',
